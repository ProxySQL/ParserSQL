...
inline constexpr KeywordEntry KEYWORDS[] = {
    ...
    {"INTERVAL", 8, TokenType::TK_INTERVAL},
    ...
    {"MEMBER", 6, TokenType::TK_MEMBER},
    {"MIN", 3, TokenType::TK_MIN},
    {"MOD", 3, TokenType::TK_MOD},
